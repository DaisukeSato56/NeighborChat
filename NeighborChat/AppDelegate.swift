...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func showIndicator(){
        ...
        if let window = window{
            ...
            activityIndicator.center = CGPoint(x: container.frame.size.width/2, y: container.frame.size.height/2);            container.addSubview(activityIndicator)
